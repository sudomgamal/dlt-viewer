    ...
    for (int i = 0; i < opt->length(); ++i)
     {
        ...
        if(str.compare("-p")==0)
        {
            ...
            if(p1.toInt()!=0 && (p1.endsWith(".dlp") || p1.endsWith(".DLP")))
             {
        ...
        if(str.compare("-l")==0)
         {
            ...
            if(l1.toInt()!=0 && (l1.endsWith(".dlt")||l1.endsWith(".DLT")))
             {
        ...
        if(str.compare("-f")==0)
         {
            ...
            if(f1.toInt()!=0 && (f1.endsWith(".dlf")||f1.endsWith(".DLF")))
             {
        ...
        if(str.compare("-c")==0)
         {
            ...
            if(c1.toInt()!=0 && (c1.endsWith(".dlt")||c1.endsWith(".DLT")) && c2.toInt()!=0)
             {
